...
navigate('/')//redirect
  ...
  <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={login}>
    ...
    <div className="mb-4">
      ...
      <input value={email}  onChange={e=> setEmail(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="email" placeholder="Username"/>
    </div>
    <div className="mb-6">
